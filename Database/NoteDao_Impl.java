  ...
  public NoteDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfNote = new EntityInsertionAdapter<Note>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR REPLACE INTO `notes_table` (`id`,`title`,`note`,`data`) VALUES (?,?,?,?)";
      }
    ...
    this.__preparedStmtOfUpdate = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "Update notes_table Set title = ?, note =? WHERE id =?";
        return _query;
      }
    };
  }
    ...
    return __db.getInvalidationTracker().createLiveData(new String[]{"notes_table"}, false, new Callable<List<Note>>() {
      ...
      public List<Note> call() throws Exception {
        ...
        try {
          ...
          final int _cursorIndexOfDate = CursorUtil.getColumnIndexOrThrow(_cursor, "data");
          ...
          while(_cursor.moveToNext()) {
            ...
            _item = new Note(_tmpId,_tmpTitle,_tmpNote,_tmpDate);
            _result.add(_item);
          }
          return _result;
        } finally {
